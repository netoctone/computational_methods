...
CompMeth.MinimizationPanel = Ext.extend(Ext.Panel, {
  initComponent: function() {
      ...
      buttons: [
        {
          ...
          handler: function() {
            form.getForm().submit({
              url: 'input/multiple_minimization.json',
    ...
    var config = {
      title: 'Multiple minimization',
      items: [ form ]
    };

    Ext.apply(this, Ext.apply(this.initialConfig, config));

    CompMeth.MinimizationPanel.superclass.initComponent.apply(this, arguments);
  }
});
